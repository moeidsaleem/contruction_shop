...
class VouchersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'promo_code' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'promo_code' => 'Lorem ipsum dolor ',
            'is_active' => 1,
            'created' => '2018-03-07 11:18:23',
            'modified' => '2018-03-07 11:18:23'
        ],
    ];
}
