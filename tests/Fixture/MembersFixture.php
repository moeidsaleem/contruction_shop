...
class MembersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'newsletter' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'newsletter' => 1,
            'is_active' => 1,
            'last_login' => '2018-03-07 14:41:14',
            'created' => '2018-03-07 14:41:14',
            'modified' => '2018-03-07 14:41:14'
        ],
    ];
}
