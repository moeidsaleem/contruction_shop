...
<html lang="en">
	<head>
		...
		<?php
			...
			echo $this->Html->script(array('/admin/js/jquery-2.1.4.min', '/admin/assets/admin/js/bootstrap.min','/admin/assets/admin/js/main','/admin/fancybox/js/jquery.fancybox', '/admin/js/bootstrapValidator.min', '/admin/js/validator','/admin/js/tock.min.js','/admin/js/main.js','/admin/strength_password/strength'));
			$jsVars = array(
