...
class ProductTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code' => ['type' => 'string', 'length' => 11, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-04-25 17:19:09',
            'modified' => '2018-04-25 17:19:09'
        ],
    ];
}
